...
/*
    ...
    accepts a 2D array representing a Sudoku board,
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean isValidSudoku = SudokuSolutionValidator.check(sudoku);
        System.out.printf("The sudoku solution is %s", isValidSudoku ? "valid" : "invalid");
    }
}
